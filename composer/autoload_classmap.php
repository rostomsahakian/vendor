...
return array(
    'AboutUs' => $baseDir . '/public_html/rock_backend/page_types/AboutUs.php',
    'AccountDetail' => $baseDir . '/public_html/rock_backend/modules/AccountDetail.php',
    'AddNewPage' => $baseDir . '/public_html/rock_backend/modules/AddNewPage.php',
    ...
    'Backend_Loader' => $baseDir . '/public_html/rock_backend/backend_controls/Backend_Loader.php',
    'Body' => $baseDir . '/public_html/rock_backend/backend_controls/templates/Body.php',
    'Brand' => $baseDir . '/public_html/rock_backend/page_types/Brand.php',
    'Brands' => $baseDir . '/public_html/rock_backend/page_types/Brands.php',
    'BrandsPromotions' => $baseDir . '/public_html/rock_backend/modules/BrandsPromotions.php',
    'BulkUpload' => $baseDir . '/public_html/rock_backend/modules/BulkUpload.php',
    'CarouselManager' => $baseDir . '/public_html/rock_backend/modules/CarouselManager.php',
    'Categories' => $baseDir . '/public_html/rock_backend/page_types/Categories.php',
    'CheckOut' => $baseDir . '/public_html/ShoppingCart/CheckOut.php',
    'Constants' => $baseDir . '/public_html/ShoppingCart/constants/Constants.php',
    'ContactUs' => $baseDir . '/public_html/rock_backend/page_types/ContactUs.php',
    'CreatePageForm' => $baseDir . '/public_html/rock_backend/modules/CreatePageForm.php',
    'DB_Connect' => $baseDir . '/public_html/rock_backend/includes/DB_Connect.php',
    'EditPages' => $baseDir . '/public_html/rock_backend/modules/EditPages.php',
    'FAQs' => $baseDir . '/public_html/rock_backend/page_types/FAQs.php',
    'FilesManager' => $baseDir . '/public_html/rock_backend/modules/FilesManager.php',
    'Footer' => $baseDir . '/public_html/rock_backend/backend_controls/templates/Footer.php',
    'Forms' => $baseDir . '/public_html/rock_backend/modules/Forms.php',
    'FrontEndLogic' => $baseDir . '/public_html/FrontEndLogic.php',
    'FrontendSearch' => $baseDir . '/public_html/rock_backend/modules/FrontendSearch.php',
    'GoogleAnalytics' => $baseDir . '/public_html/rock_backend/modules/GoogleAnalytics.php',
    'GuestCheckOut' => $baseDir . '/public_html/ShoppingCart/GuestCheckOut.php',
    'Header' => $baseDir . '/public_html/rock_backend/backend_controls/templates/Header.php',
    'HomePage' => $baseDir . '/public_html/rock_backend/page_types/HomePage.php',
    'ImagesBulkUpload' => $baseDir . '/public_html/rock_backend/modules/ImagesBulkUpload.php',
    'LeftSide' => $baseDir . '/public_html/rock_backend/modules/LeftSide.php',
    'Login' => $baseDir . '/public_html/rock_backend/admin/Login.php',
    'Logo_manager' => $baseDir . '/public_html/rock_backend/modules/Logo_manager.php',
    'Logout' => $baseDir . '/public_html/rock_backend/modules/Logout.php',
    'ModuleControler' => $baseDir . '/public_html/rock_backend/modules/ModuleControler.php',
    'NavPromoImages' => $baseDir . '/public_html/rock_backend/modules/NavPromoImages.php',
    'Navigation' => $baseDir . '/public_html/rock_backend/modules/Navigation.php',
    'NewPages' => $baseDir . '/public_html/rock_backend/modules/NewPages.php',
    'NoneProductCategories' => $baseDir . '/public_html/rock_backend/page_types/NoneProductCategories.php',
    'OrderReview' => $baseDir . '/public_html/ShoppingCart/OrderReview.php',
    'Policies' => $baseDir . '/public_html/rock_backend/page_types/Policies.php',
    'ProductPage' => $baseDir . '/public_html/rock_backend/modules/ProductPage.php',
    'Products' => $baseDir . '/public_html/rock_backend/page_types/Products.php',
    'Profile' => $baseDir . '/public_html/rock_backend/modules/Profile.php',
    'Queries' => $baseDir . '/public_html/rock_backend/includes/Queries.php',
    'ReCaptcha' => $baseDir . '/public_html/rock_backend/page_types/recaptchalib.php',
    'ReCaptchaResponse' => $baseDir . '/public_html/rock_backend/page_types/recaptchalib.php',
    'Reviews' => $baseDir . '/public_html/rock_backend/page_types/Reviews.php',
    'RightSide' => $baseDir . '/public_html/rock_backend/modules/RightSide.php',
    'SearchResults' => $baseDir . '/public_html/rock_backend/page_types/SearchResults.php',
    'SellsReports' => $baseDir . '/public_html/rock_backend/modules/SellsReports.php',
    'ShoppingCart' => $baseDir . '/public_html/rock_backend/modules/ShoppingCart.php',
    'ShoppingCartFunc' => $baseDir . '/public_html/ShoppingCart/ShoppingCartFunc.php',
    'Signup' => $baseDir . '/public_html/rock_backend/admin/Signup.php',
    'SocialMedia' => $baseDir . '/public_html/rock_backend/modules/SocialMedia.php',
    'StaticPage' => $baseDir . '/public_html/rock_backend/page_types/StaticPage.php',
    'StoreInfo' => $baseDir . '/public_html/rock_backend/modules/StoreInfo.php',
    'StuckManager' => $baseDir . '/public_html/rock_backend/modules/StuckManager.php',
    'SubCategories' => $baseDir . '/public_html/rock_backend/page_types/SubCategories.php',
    'SubCategory' => $baseDir . '/public_html/rock_backend/modules/SubCategory.php',
    'Themes' => $baseDir . '/public_html/rock_backend/modules/Themes.php',
    'UrlOptions' => $baseDir . '/public_html/rock_backend/modules/UrlOptions.php',
    'UserCheckOut' => $baseDir . '/public_html/ShoppingCart/UserCheckOut.php',
    'WholeSaleRegLog' => $baseDir . '/public_html/rock_frontend/custom/forms/WholeSaleRegLog.php',
    'WholesalerManager' => $baseDir . '/public_html/rock_backend/modules/WholesalerManager.php',
    'accounts' => $baseDir . '/public_html/rock_frontend/pagetypes/accounts.php',
    'hiddenPage' => $baseDir . '/public_html/rock_backend/page_types/hiddenPage.php',
    ...
    'xmlsitemap' => $baseDir . '/public_html/rock_frontend/sitemap/xmlsitemap.php',
);
